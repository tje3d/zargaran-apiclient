...
**Logic Notes:**
- `deposit.irt.active`: `false` if `payment_status == 'deactive'` OR `trader.payment_status == 'deactive'` OR `payment_gateway == 'deactive'` (whitelisted traders bypass)
- `deposit.usdt.active`: `true` if `deposit_usdt_status != 'deactive'`
- `deposit.neodigi.active`: `true` if `deposit_neodigi_status == 'active'` OR trader is whitelisted
- `withdraw.irt.active`: `true` if `irt_withdraw != 'deactive'` AND `trader.payment_status != 'deactive'`
- `withdraw.usdt.active`: `true` if `withdraw_usdt_status != 'deactive'` AND `trader.withdraw_coin_status != 'disable'`
- `withdraw.neodigi.active`: `true` if `withdraw_neodigi_status == 'active'` OR trader is whitelisted
